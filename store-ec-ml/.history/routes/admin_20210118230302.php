    ...
    function () {
        ...
        Route::group([
            ...
            Route::group(['prefix'=>'Control-Panel-User'],function(){
                ...
                Route::post('/store-controlToUser','ControlPanelUserController@Store')->name('store-control-user');
                Route::get('/update-controlToUser/{id}','ControlPanelUserController@Edit')->name('edit-control-user');
                Route::get('/delete-controlToUser','ControlPanelUserController@Delete')->name('delete-control-user');
            ...
            Route::group(['prefix' => 'brands',"middleware" => "can:admin"], function () {
