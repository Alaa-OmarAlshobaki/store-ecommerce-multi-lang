...
Route::group([ "prefix"=>"admin",
    ...
    Route::group(['prefix'=>'main-category'],function(){
         ...
         Route::get('/{typeEdit}/{id}/','MainCategoryController@Edit')->name('edit.category');
         Route::post('/{typeUpdate}/{id}','MainCategoryController@Update')->name('update.category');
         Route::get('/{typeDelete}/{id}','MainCategoryController@Delete')->name('delete.category');
