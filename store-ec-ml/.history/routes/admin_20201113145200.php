...
Route::group([ "prefix"=>"admin",
    ...
    Route::group(['prefix'=>'tags'],function(){
         Route::get('/','TagsController@Index')->name('main.brands');
         Route::get('/create-brand','TagsController@Create')->name('create.brands');
         Route::get('/store-brand','TagsController@Store')->name('store.brands');
         Route::post('/store-brand','TagsController@Store')->name('store.brands');
         Route::get('/edit-brand/{id}','TagsController@Edit')->name('edit.brands');
         Route::post('/update-brand/{id}','TagsController@Update')->name('update.brands');
         Route::get('/delete-brand/{id}','TagsController@Delete')->name('delete.brands');
