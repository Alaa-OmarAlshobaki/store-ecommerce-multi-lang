...
Route::group([ "prefix"=>"admin",
    ...
    Route::group(['prefix'=>'products'],function(){
         ...
         Route::get('/store-product','ProductController@Store')->name('store.tags');
         Route::get('/edit-product/{id}','ProductController@Edit')->name('edit.tags');
         Route::post('/update-product/{id}','ProductController@Update')->name('update.tags');
         Route::get('/delete-product/{id}','ProductController@Delete')->name('delete.tags');
