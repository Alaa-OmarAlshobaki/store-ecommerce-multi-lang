...
Route::group([ "prefix"=>"admin",
    ...
    Route::group(['prefix'=>'main-category'],function(){
         Route::get('/','MainCategoryController@Index')->name('main.categories');
         Route::post('EditCategory/{id}','MainCategoryController@Edit')->name('edit.category');
         Route::post('UpdateCategory/{id}','MainCategoryController@Update')->name('edit.category');
         Route::post('DeleteCategory/{id}','MainCategoryController@Delete')->name('delete.category');
