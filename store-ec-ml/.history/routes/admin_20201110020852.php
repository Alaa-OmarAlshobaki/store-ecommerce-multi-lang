...
Route::group([ "prefix"=>"admin",
    ...
    Route::group(['prefix'=>'brands'],function(){
         ...
         Route::get('/{typeCreate}/create','BrandController@Create')->name('create.categories');
         Route::post('/{typeStore}/store','BrandController@Store')->name('store.category');
         Route::get('/{typeEdit}/{id}/edit','BrandController@Edit')->name('edit.category');
         Route::post('/{typeUpdate}/{id}/update','BrandController@Update')->name('update.category');
         Route::get('/{typeDelete}/{id}/delete','BrandController@Delete')->name('delete.category');
