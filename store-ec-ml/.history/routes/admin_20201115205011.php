...
Route::group([ "prefix"=>"admin",
    ...
    Route::group(['prefix'=>'brands'],function(){
        Route::get('/','CategoryController@Index')->name('main.brands');
        Route::get('/create-brand','CategoryController@Create')->name('create.brands');
        Route::get('/store-brand','CategoryController@Store')->name('store.brands');
