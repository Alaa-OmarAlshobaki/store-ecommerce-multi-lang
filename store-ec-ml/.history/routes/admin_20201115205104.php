...
Route::group([ "prefix"=>"admin",
    ...
    Route::group(['prefix'=>'brands'],function(){
        ...
        Route::get('/store-cat','CategoryController@Store')->name('store.cat');
        Route::post('/store-brand','CategoryController@Store')->name('store.cat');
        Route::get('/edit-brand/{id}','CategoryController@Edit')->name('edit.cat');
        Route::post('/update-brand/{id}','CategoryController@Update')->name('update.cat');
        Route::get('/delete-brand/{id}','CategoryController@Delete')->name('delete.cat');
