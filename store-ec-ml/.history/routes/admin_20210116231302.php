    ...
    function () {
        ...
        Route::group([
            ...
            Route::group(['prefix'=>'roles'],function(){
                ...
                Route::get('/edit-permission/{id}','RolesController@EditPermission')->name('edit-roles');
                Route::post('/update-permission/{id}','RolesController@UpdatePermission')->name('update-roles');
                Route::post('/delete-permission/{id}','RolesController@DeletePermission')->name('update-roles');
