    ...
    function () {
        ...
        Route::group([
            ...
            Route::group(['prefix' => 'slider'], function () {
                Route::get('slider/View-Uploads', 'ProductController@ViewImages')->name('products.View.Upload');
                Route::post('slider/store-Images', 'ProductController@StoreImages')->name('products.Store.Upload');
                Route::post('slider/store-ImagesDB', 'ProductController@StoreImagesDB')->name('products.Store.UploadDB');
                Route::post('slider/delete-Image/{product_id}/{id}', 'ProductController@DeleteImage')->name('product.Delete.Image');
            });
        });
        Route::group([
            "prefix" => "admin",
