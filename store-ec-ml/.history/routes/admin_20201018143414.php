...
Route::group([ "prefix"=>"admin",
    ...
    Route::group(['prefix'=>'main-category'],function(){
         ...
         Route::post('EditCategory','MainCategoryController@Delete')->name('delete.category');
         Route::post('DeleteCategory','MainCategoryController@Delete')->name('delete.category');
