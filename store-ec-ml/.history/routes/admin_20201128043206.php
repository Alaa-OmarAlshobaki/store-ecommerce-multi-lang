...
Route::group([ "prefix"=>"admin",
    ...
    Route::group(['prefix'=>'products'],function(){
         ...
         Route::post('products/create-step-two', 'ProductController@postCreateStepOne')->name('products.create.step.one.post');
         Route::post('products/create-step-three', 'ProductController@postCreateStepTwo')->name('products.create.step.two.post');
         Route::post('products/create-step-four', 'ProductController@postCreateStepThree')->name('products.create.step.three.post');
         Route::post('products/create-step-five', 'ProductController@postCreateStepThree')->name('products.create.step.four.post');
