...
trait GeneralTraites
{
    function uploadImage($folder,$image){
      
       return $image->store('/', $folder);
        $filename = $image->hashName();
        return  $bath='storage\uploads';
     }
     D:\my project\store-ecommerce-multi-lang\store-ec-ml\public\storage\uploads\brands\MNhsaVsJ5wDcNi3cbGK1kodevxfWNwz1KwrMmJ49.jpeg
    ...
    public function returnDynamic(...$params)
    {
