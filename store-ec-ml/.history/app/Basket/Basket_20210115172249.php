...
class Basket
{
	...
	*/
	...
	public function productTotal(Product $product, $quantity)
	{
	
		$priceProd= $this->storage->get($product);
		return $priceProd;
		$pric=Product::where('id',$priceProd['product_id'])->first();
