...
class SettingController extends Controller
{
    public function ViewMethodShipping($type){
        ...
        elseif ($type==='local') {
            $shipping = return Setting::where('key','local_label')->first();
        }elseif ($type==='outer') {
            $shipping =return Setting::where('key','outer_label')->first();
        }
        else{
            $shipping =return Setting::where('key','free_shipping_label')->first();
        }
