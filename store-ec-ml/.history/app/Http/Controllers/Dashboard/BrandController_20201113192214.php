...
public function Delete(Request $request,$id){
    try{
        ...
        return \File::exists(public_path('storage/uploads/brands/'.$brand->image);
        if(\File::exists(public_path('storage/uploads/brands/'.$brand->image))){

            \File::delete(public_path('storage/uploads/brands/'.$brand->image));
