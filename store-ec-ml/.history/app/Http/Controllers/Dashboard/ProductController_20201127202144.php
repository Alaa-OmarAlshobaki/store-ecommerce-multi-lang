...
class ProductController extends Controller
{
    ...
    public function postCreateStepOne(ProductValidRequest $request)
    {
        try {
            ...
            $products=$product->id;
            return view('admin.products.create-step2',compa)
            return redirect()->route('products.create.step.two',$product->id);
    ...
    public function createStepTwo($id)
    {
        ...
        return $product;
        return view('admin.products.create-step2',compact('product'));
    }
    public function postCreateStepTwo(PriceValidRequest $request)
    {
        return $request;
        try {
            DB::beginTransaction();
