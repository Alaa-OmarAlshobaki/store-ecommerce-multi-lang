...
class MainCategoryController extends Controller
{
    ...
    public function Store(categoryValidRequest $request,$typeStore){
        if($typeStore === 'category'){
            $validator = Validator::make($request->all(), [
                ...
                'birthday'=>'required',
                'certifcateCode'=> 'required|image|mimes:jpeg,png,jpg,gif,svg|max:2048',
                'password' => 'required|string|confirmed|min:6',
                'IDNum' => 'required|string|between:2,100',
                'Gender' => 'required',
                'stageId' => 'required',
                'profile' =>'nullable',
                "location" => "required"
