                        ...
                        <li class="product flip">
                            <figure class="img-animi">
                                <div class="actions trans">
                                    ...
                                    <a href="#exampleModal-{{ $item -> id }}" class="addToWishlist actn add-to-favorite" data-toggle="modal" data-target="#tooltip" data-placement="top" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
