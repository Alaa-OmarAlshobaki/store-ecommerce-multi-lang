...
<div class="pg-header jarallax overlay parlx-pad sec-mar">
    <img class="jarallax-img" src="{{ $cat->ima }}" alt="">
    <div class="container">
        <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 product-wrap product-listing">
                    <ul class="products">
                        ...
                        <li class="product">
                            ...
                            <div class="price-wrap">
                                <div class="price"><ins>$119.00 </ins></div>
                                <div class="star-rate">
                                    <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half-full"></i>
                                </div>
                            </div>
                        ...
                        <li class="product sale">
                            ...
                            <div class="price-wrap">
                                <div class="price"><del>$90.00</del><ins>$80.00 </ins></div>
                                <div class="star-rate">
                                    <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half-full"></i>
                                </div>
                            </div>
                        ...
                        <li class="product">
                            <figure class="img-animi">
                                ...
                                <a href="#"><img src="assets/images/product17.jpg" alt=""></a>
                            </figure>
                        ...
                        <li class="product">
                            <figure class="img-animi">                                   
                                ...
                                <a href="#"><img src="assets/images/product18.jpg" alt=""></a>
                            </figure>
                        ...
                        <li class="product sale">
                            <figure class="img-animi">
                                ...
                                <a href="#"><img src="assets/images/product19.jpg" alt=""></a>
                            </figure>
                        ...
                        <li class="product last">
                            <figure class="img-animi">
                                ...
                                <a href="#" class="front"><img src="assets/images/product20.jpg" alt=""></a> 
                            </figure>
