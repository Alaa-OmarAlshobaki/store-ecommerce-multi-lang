                            ...
                            <figure class="img-animi">
                                <div class="actions trans">
                                 ...
                                 <form action="" method="post">
                                    ...
                                    <a href="#" class="actn add-to-cart" data-product-id="{{$item->id}}" data-product-slug="{{ $item }}" data-toggle="tooltip" data-placement="top" title="Add to Cart"><i class="pe-7s-cart"></i></a>
                                 </form>
