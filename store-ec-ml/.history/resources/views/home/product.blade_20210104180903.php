...
<main class="main"> 
                        ...
                        <li class="product flip">
                            <figure class="img-animi">
                                <div class="actions trans">
                                    ...
                                    <a href="#"  data-product-id="{{$item -> id}}" class="actn Quick-View" data-toggle="modal" data-target="#exampleModal" data-toggle="tooltip" data-placement="top" data-rel="quickview-popup" title="Quick View"><i class="pe-7s-look"></i></a>
                                </div>
 ...
 <script>
    $(document).on('click', '.Quick-View', function () {
        $('.product-' + $(this).attr('data-product-id')).css("display", "block");
    });
    $(document).on('click', '.lightcase-icon-close', function () {
        $('.product-' + $(this).attr('data-product-id')).css("display", "none");
    });
