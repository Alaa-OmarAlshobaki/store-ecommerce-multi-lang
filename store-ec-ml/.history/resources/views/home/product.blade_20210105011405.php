                        ...
                        <li class="product flip">
                            <figure class="img-animi">
                                <div class="actions trans">
                                    ...
                                    <a href="#" class="actn add-to-favorite" data-toggle="modal" data-target="#exampleModal" data-tarrget-id="{{ $item->id }}" data-placement="top" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
