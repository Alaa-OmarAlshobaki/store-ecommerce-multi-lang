                        ...
                        <li class="product flip">
                            <figure class="img-animi">
                                <div class="actions trans">
                                    ...
                                    <a href="#" id="addToWishlist" class=" quick-view actn add-to-favorite" data-toggle="modal" data-target="#tooltip" data-placement="top" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                 
                                    <a href="#quick-view-popup-wishlist-{{ $item -> id }}" class="actn add-to-cart" data-toggle="tooltip" data-placement="top" title="Add to Cart"><i class="pe-7s-cart"></i></a>
