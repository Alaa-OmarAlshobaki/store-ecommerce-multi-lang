                ...
                <div class="col-md-12 col-sm-12">                        
                    <table class="table_shop">
                        ...
                        <tbody>
                            ...
                            <tr class="crt_itm">
                                <td class="pdt_remove" data-prodouct-id="{{ $item->id }}" data-product-slug="" data-title="Remove"> <a onclick="$(this).closest('.crt_itm').remove()" class="remove-from-cart" href="#"><i class="pe-7s-close"></i></a> </td>
