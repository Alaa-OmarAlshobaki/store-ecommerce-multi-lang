                        ...
                        <li class="product flip">
                            <figure class="img-animi">
                                <div class="actions trans">
                                    ...
                                    <a href="#quick-view-popup" data-product-id= class="actn" data-toggle="tooltip" data-placement="top" data-rel="quickview-popup" title="Quick View"><i class="pe-7s-look"></i></a>
                                </div>
