                        ...
                        <li class="product flip">
                            <figure class="img-animi">
                                <div class="actions trans">
                                    ...
                                    <a href="#"  data-product-id="{{$item -> id}}" class="actn"  data-target="#quick-view-popup" data-toggle="tooltip" data-placement="top" data-rel="quickview-popup" title="Quick View"><i class="pe-7s-look"></i></a>
                                </div>
