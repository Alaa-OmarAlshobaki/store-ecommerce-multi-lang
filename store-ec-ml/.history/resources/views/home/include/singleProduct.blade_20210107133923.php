                            ...
                            <li class="product">
                                <figure class="img-animi">
                                    ...
                                    <a href="#" class="actn add-to-cart" data-toggle="tooltip" data-placement="top" title="Add to Cart"><i class="pe-7s-cart"></i></a>
                                        <a href="{{ route() }}" class="actn quick-view" data-tarrget-id="{{ $related_product->slug }}" data-toggle="tooltip" data-placement="top" title="Quick View"><i class="pe-7s-look"></i></a>
                                    </div>
...
//  },
//                    type: 'get',
//                    url: "{{Route('single.product.view',$related_product->slug)}}",
//                    data: {
//                        'slug': $(this).attr('data-tarrget-id'),
//                    },
//                    success: function (data) {
