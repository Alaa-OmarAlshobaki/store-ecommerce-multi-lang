                            ...
                            <li class="product">
                                <figure class="img-animi">
                                    ...
                                    <a href="#" class="actn add-to-cart" data-toggle="tooltip" data-placement="top" title="Add to Cart"><i class="pe-7s-cart"></i></a>
                                        <a href="#" class="actn quick-view" data-tarrget-id="{{ $related_product->id }}" data-toggle="tooltip" data-placement="top" title="Quick View"><i class="pe-7s-look"></i></a>
                                    </div>
...
<script>
  $('.add-to-favorite').on('click', function (e) {
   ...
   'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                   ...
                   data: {
                       ...
                       'slug': $(this).attr('data-tarrget-slug'),
                   },
  ...
  $('.quick-view').on('click', function (e) {
   ...
   'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                   ...
                   type: 'post',
                   url: '{{Route("single.product.view",$item->slug)}}',
                   data: {
                       'productId': $(this).attr('data-tarrget-id'),
                       'productId': $(this).attr('data-tarrget-id'),
                   },
