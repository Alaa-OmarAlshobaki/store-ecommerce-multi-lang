<div id="" class="modal fade quickview in quickview-modal-product-details-{{$item -> id}}" tabindex="-1" role="dialog" style="display: hidden;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close"  data-product-id="{{$item -> id}}" data-dismiss="modal" aria-label="Close"><i class="material-icons close">close</i></button>
            </div>
                    ...
                    <div class="col-md-5 col-sm-5 divide-right">
                        <div class="images-container bottom_thumb">
                            <div class="product-cover">
                                <img class="js-qv-product-cover img-fluid" src="{{$item -> images[0] -> photo ?? ''}}" alt="" title="" style="width:100%;" itemprop="image">
                        ...
                        <div class="product-prices">
                            <div class="product-price " itemprop="offers" itemscope="" itemtype="https://schema.org/Offer">
                                <div class="current-price">
                                     <span itemprop="price"
                                          class="price">{{$item -> special_price ?? $item -> price }}</span>
                                    @if($item -> special_price)
                                        <span
                                            class="regular-price">{{$item -> price}}</span>
                                    @endif
                                </div>
                            </div>
