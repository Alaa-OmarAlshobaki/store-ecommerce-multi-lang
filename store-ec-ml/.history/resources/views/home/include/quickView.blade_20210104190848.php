<div id="quick-view-popup" class="quickview-modal-product-details-{{$product -> id}}" style="display: none">
    <div class="qv-wrap">
            ...
            <div class="col-md-6 col-sm-6 summary ">
                <div class="wrap">
                    ...
                    <div class="price-wrap">
                        <div class="price"><del>{{ $item->price }}</del><ins>{{ $item->special_price ? $item->special_price : 'no special price'  }}</ins></div>
                        <div class="star-rate">
