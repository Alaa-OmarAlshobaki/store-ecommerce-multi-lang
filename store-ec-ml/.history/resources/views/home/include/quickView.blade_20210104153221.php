<div id="quick-view-popup" class="modal fade quickview in quickview-modal-product-details-{{$item -> id}}" >
    <div class="qv-wrap">
                ...
                <div class="product-thumb-slider layout-btm-thumb">
                    <div class="slide-top">
                        <ul class="qv-single-image single-2">
                            ...
                            <li>
                                <figure><img src="{{ $item->image[$key]->photo }}" alt=""></figure>
                            </li>
                    ...
                    <ul class="qv-single-thumb thumb-2">
                        ...
                        <li>
                            <figure><img src="{{ $item->image[]->photo }}" alt=""></figure>
                        </li>
