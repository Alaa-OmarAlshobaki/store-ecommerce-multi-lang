                        ...
                        <ul class="products product-slider">
                            ...
                            <li class="product">
                                <figure class="img-animi">
                                    ...
                                    <a href="#" class="actn add-to-cart" data-toggle="tooltip" data-placement="top" title="Add to Cart">
                                        <i class="pe-7s-cart"></i></a>
                                        <a href="#quick-view-popup-{{ $item -> id }}" class="actn quick-view" data-toggle="tooltip" data-placement="top" data-rel="quickview-popup" title="Quick View">
                                            <i class="pe-7s-look"></i></a>
                                        {{-- <a href="#quick-view-popup-{{ $item -> id }}" class="quick-view actn"
                                            data-toggle="tooltip" data-placement="top" data-rel="quickview-popup" title="Quick View">
                                            <i class="pe-7s-look"></i></a> --}}
                                    </div>
                            ...
                            @include('home.include.quickViewCustom',$item)
                            @endforeach
                            @endif
                            <!--product-->
