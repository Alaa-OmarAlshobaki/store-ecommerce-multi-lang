            ...
            <div class="col-md-4 col-sm-4 summary ">
                <div class="wrap">
                    ...
                    <div class="btn-wrap bm-30">
                        ...
                        <input type="number" value="1"  title="Qty" id="qty" class="input-text qty" size="4">
                        <a href="#" id="add-item-cart" data-product-id="{{ $product->id }}" data-product-slug="{{ $product->slug }}" class="btn add-item-cart pri-bg"><i class="pe-7s-cart"></i> ADD TO CART</a>
                        </form>
