            ...
            <div class="col-md-4 col-sm-4 summary ">
                <div class="wrap">
                    ...
                    <div class="btn-wrap bm-30">
                        ...
                        <a href="#" data-product-id="{{ $product->id }}" data-product-slug="{{ $product->slug }}" class="btn add-item-cart pri-bg"><i class="pe-7s-cart"></i> ADD TO CART</a>
                        </form>
...
@section('script')
<script>
     $(document).on('click', '.add-ite-cart', function (e) {
            e.preventDefault();
            $.ajaxSetup({
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
