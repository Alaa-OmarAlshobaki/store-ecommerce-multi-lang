            ...
            <div class="col-md-4 col-sm-4 summary ">
                <div class="wrap">
                    ...
                    <div class="color-option bm-25">
                        <h6 class="bm-5">Select  @if($attribute->name == 'color') {{  $attribute->name}} @endif</h6>

                        <div class="color-filter">
                            <form>
                                 @foreach($attribute->Option  as $opt) 

                                <div class="radio-wrap {{ $opt->name }}">
                    ...
                    <div class="size-option bm-30">
                        <h6 class="bm-5">Select @if($attribute->name == 'size') {{  $attribute->name}} @endif</h6>
