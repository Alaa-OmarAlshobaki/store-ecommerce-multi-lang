                ...
                <div class="account-content">
                    <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                        <div class="row">
                            ...
                            <form id="general-info" action="{{update.profile}}" class="section general-info" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                                        ...
                                                        <div class="form">
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <input type="text" class="form-control mb-4" id="fullName" placeholder="" value="{{$admin->name}}">
                                                                    </div>
                                                                </div>
                                                                {{-- <div class="col-sm-6">
                                                            ...
                                                            <div class="row">
                                                               <div class="col-sm-6">
                                                                    ...
                                                                    <input type="email" class="form-control mb-4" id="email" placeholder="" value="{{$admin->email}}">
                                                                    </div>
                                                               </div>
                                                            </div>
                                                            <div class="row">
