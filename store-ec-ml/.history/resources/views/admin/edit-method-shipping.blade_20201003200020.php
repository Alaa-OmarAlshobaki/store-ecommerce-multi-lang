                    ...
                    <form class="needs-validation" novalidate action="{{route('method.shipping.update',$shipping->id)}}" method="POST">
                        ...
                        @method('PUT')
                            ...
                            <div class="form  ">
                                ...
                                <input type="hidden" value="{{$shipping->id}}" class="form-control"> 
                                <label for="validationCustom01">{{__('admin/setting.Method_name')}}</label>
                                    <input type="text" class="form-control" id="validationCustom01" placeholder="" value="{{$shipping->value}}"  required>
                                 @error('value')
                                ...
                                <div class="col-md-4 mb-4">
                                <label for="validationCustom02">{{__('admin\setting.Val')}}</label>
                                    <input type="number" class="form-control" id="validationCustom02" value="{{$shipping->value}}" placeholder=""  required>
