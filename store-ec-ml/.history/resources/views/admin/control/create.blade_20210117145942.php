     ...
     <div class="row">
        <div id="custom_styles" class="col-lg-12 layout-spacing col-md-12">
            <div class="statbox widget box box-shadow">
                ...
                <form class="needs-validation" novalidate action="{{ route('store-permission') }}" method="post">
                    @csrf
                        <div class="form-row">
                            ...
                            <input type="email" class="form-control" id="validationCustom01" placeholder=""  name="email" required>
                                @error('email')
                                <p class="text-danger"> {{$message}}</p>
                        ...
                        <div class="form-row">
                            ...
                            <input type="password" class="form-control" id="validationCustom01" placeholder=""  name="password" required>
                                @error('password')
                                <p class="text-danger"> {{$message}}</p>
                        ...
                        <div class="form-row">
                            <div class="col-md-5 mb-6">
                                ...
                                <select class="form-control tagging" name=""
                                    multiple="multiple">
                                    <option value=""></option>
