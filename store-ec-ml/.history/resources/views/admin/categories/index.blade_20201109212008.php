...
<div class="row layout-spacing">
    <div class="col-lg-12">
        <div class="statbox widget box box-shadow">
            ...
            <a href="{{route('create.categories','category')}}" class="bs-tooltip float-right mr-3" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add Category">
                        ...
                        <tbody>
                            ...
                            <td>
                                ...
                                <td class="text-center">
                                    {{route('delete.category',[$item->id,'subcategory'])}}
                                    <a href="{{route('delete.category',category,$item->id)}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
                                        <i class="fal fa-trash-alt fa-2x mr-2"></i>
                                    </a>
                                    <a href="{{route('edit.category',category,$item->id)}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
