                    ...
                    @csrf
                        <div class="form-row">
                            ...
                            <div class="col-md-2 mb-6 ">
                                <div class="avatar avatar-xl avatar-indicators avatar-offline @if($cat->is_active == 0 )avatar-online @else @endif ">
                        ...
                        <div class="form-group mb-4">
                            <div class="form-check pl-0">
                                <div class="custom-control custom-checkbox checkbox-success">
                                    <input type="checkbox" class="custom-control-input" id="invalidCheck" @if($cat->is_active == 0 )checked @endif>
