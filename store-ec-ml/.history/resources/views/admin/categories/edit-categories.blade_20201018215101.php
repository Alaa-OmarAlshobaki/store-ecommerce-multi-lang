            ...
            <div class="statbox widget box box-shadow">
                ...
                <form class="needs-validation" novalidate action="{{route('update.category',$cat->id)}}" method="post">
                    @csrf
                        ...
                        <div class="form-row">  
                             <div class="col-md-4 mb-6">
                            <div class="avatar avatar-xl custom-file-container__custom-file__custom-file-control">
                                <img alt="avatar" src="{{asset('asset/admin/assets/img/image.png')}}" class="rounded" />
                            </div>
                            </div></div>
