                            ...
                            <td>
                                ...
                                <td class="text-center">
                                    <a href="{{route('delete.category',$item->id)}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
                                        <i class="fal fa-folder-times fa-2x"></i>
                                    </a>
                                    <a href="{{route('delete.category',$item->id)}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="">
                                        <i class="fal fa-folder-times fa-2x"></i>
                                    </a>
