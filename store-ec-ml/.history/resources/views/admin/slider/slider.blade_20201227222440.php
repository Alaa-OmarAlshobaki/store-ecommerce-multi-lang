...
<div class="container">
    ...
    <form method="post" action="{{route('products.Store.UploadDB')}}" enctype="multipart/form-data" 
...
<div class="container">
    <div class="row">
        ...
        <form method="post" action="{{route('product.Delete.Image',[$img->id,$img->product_id])}}" enctype="multipart/form-data"  >
            @csrf
            <img src="{{$img->photo}}"  alt="Nature" style="width:20%">
...
<script>
   ...
   Dropzone.options.dpzMultipleFiles = {
       ...
       ,
       url: "{{ route('products.Store.Upload') }}", // Set the url
       success:
