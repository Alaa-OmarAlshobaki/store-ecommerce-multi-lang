                    ...
                    <form class="needs-validation" novalidate action="{{route('method.shipping.update',$shipping->id)}}" method="POST">
                        ...
                        @method('PUT')
                            ...
                            <div class="form  ">
                                ...
                                <input type="text" value="{{$shipping->id}}" class="form-control"> 
                                <label for="validationCustom01">{{__('admin/setting.Method_name')}}</label>
                                    <input type="text" class="form-control" name="val" id="validationCustom01" placeholder="" value="{{$shipping->value}}"  required>
                                 @error('value')
                                ...
                                <label for="validationCustom02">{{__('admin\setting.Value')}}</label>
                                    <input type="number" class="form-control" id="validationCustom02" value="{{$shipping->plain_value}}" placeholder=""  required>
                                    @error('plain_value')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                                </div>
