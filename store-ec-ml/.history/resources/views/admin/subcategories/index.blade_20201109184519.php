...
<div class="row layout-spacing">
    <div class="col-lg-12">
        <div class="statbox widget box box-shadow">
            ...
            <a href="{{route('create.categories','subcategory')}}" class="bs-tooltip float-right mr-3" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add Category">
                    ...
                    <table id="individual-col-search" class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>@lang('admin/subcategory.name')</th>
                        ...
                        <tbody>
                            ...
                            <td>
                                ...
                                <td class="text-center">
                                    <a href="{{route('delete.category',['typeDelete'=>'subcategory','id'=>$item->id])}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
                                        <i class="fal fa-trash-alt fa-2x mr-2"></i>
                                    </a>
                                    <a href="{{route('edit.category',['typeEdit'=>'subcategory','id'=>$item->id])}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
