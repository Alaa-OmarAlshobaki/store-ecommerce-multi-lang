    ...
    <div class="row mb-4 mt-3">
        <div class="col-sm-3 col-12">
            <div class="nav flex-column nav-pills mb-sm-0 mb-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              ...
              <a class="nav-link mb-2" id="v-pills-messages-tab" data-toggle="pill" href="#shipping" role="tab" aria-controls="v-pills-messages" aria-selected="false">Sipping Method</a>
