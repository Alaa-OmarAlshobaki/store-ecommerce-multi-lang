                    ...
                    @method('PUT')
                        <div class="form">
                            ...
                            <div id="email-field" class="field-wrapper input">
                                ...
                                <input id="old" name="password" type="password" class="form-control" value="" placeholder="Old Password">
                            </div>
                            ...
                            <div id="email-field" class="field-wrapper input">
                                ...
                                <i class="fal fa-lock-alt mt-3"></i>
                                 <input id="password" name="new" type="password" class="form-control" value="" placeholder="New Password">
                            </div>
                            <div id="email-field" class="field-wrapper input">
                                <div class="d-flex justify-content-between">
