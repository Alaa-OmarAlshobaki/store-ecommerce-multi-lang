                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>@lang('admin/category.edit_category')&nbsp;{{$brand->name}}</h4>
                        </div>                 
                    </div>
                </div>
                <div class="widget-content widget-content-area">                                
                <form class="needs-validation" novalidate action="{{route('update.brands',$brand->id)}}" method="post">
                    @csrf
                        <div class="form-row">
                        <input type="hidden" value="{{$brand->id}}" name="id">
                            ...
                            <div class="col-md-2 mb-6 ">
                                <div class="avatar avatar-xl avatar-indicators  @if($->is_active == 0 )avatar-online @else avatar-offline @endif ">
