...
<div class="row layout-spacing">
    <div class="col-lg-12">
        <div class="statbox widget box box-shadow">
            ...
            <a href="{{route('create.brands')}}" class="bs-tooltip float-right mr-3" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add Category">
                ...
                <div class="table-responsive mb-4">
                    <table id="individual-col-search" class="table table-hover">
                        ...
                        <tbody>
                            ...
                            @foreach ($brand as $indexKey => $item)
                            ...
                            <td>
                                ...
                                <img alt="avatar" src="{{asset('storage/uploads/brands/'.$item->image)}}" class="rounded-circle" />
                                </div>
                            </td>
                                ...
                                <td class="text-center">
                                    <a href="{{route('delete.category',[$item->id,'category'])}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
                                        <i class="fal fa-trash-alt fa-2x mr-2"></i>
                                    </a>
                                    <a href="{{route('edit.category',[$item->id,'category'])}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
