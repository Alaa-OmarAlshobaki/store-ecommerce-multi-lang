            ...
            <div class="statbox widget box box-shadow">
                ...
                <form class="needs-validation" novalidate action="{{route('store.cat')}}"  enctype="multipart/form-data" method="post">
                    @csrf
                        ...
                        <div class="form-row hidden " id="cats_list">
                            <div class="col-md-5 mb-6">
                                <label for="validationCustom02">@lang('admin/category.link')</label>
                                <select class="form-control  basic" id="cat" name="parent_id" disabled required>
                                    ...
                                    <div class="input-group-text">
                                        <div class="n-chk align-self-end">
                                            <label class="new-control new-radio radio-info" style="height: 21px; margin-bottom: 0; margin-right: 0">
                                                <input type="radio" name="type" class="new-control-input" name="custom-radio-1" checked>
                            ...
                            <div class="input-group mb-4">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        <div class="n-chk align-self-end">
                                            <label class="new-control new-radio radio-info" style="height: 21px; margin-bottom: 0; margin-right: 0">
                                                <input type="radio" name="type" class="new-control-input" id="show" name="custom-radio-1" checked>
                                                <span class="new-control-indicator"></span>
                                            </label>
                                        </div>
                                    </div>
