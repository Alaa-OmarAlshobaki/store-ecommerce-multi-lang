     ...
     <div class="row">
        <div id="custom_styles" class="col-lg-12 layout-spacing col-md-12">
            <div class="statbox widget box box-shadow">
                ...
                <form class="needs-validation" novalidate action="{{route('update.brands',$cate->id)}}"  enctype="multipart/form-data" method="post">
                    @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="col-md-5 mb-6 invisible" id="cats_list">
                                ...
                                <select class="form-control  basic"  name="parent_id"  >
                                    ...
                                    <option value="{{$item->id}} " @if($item->id == $cat->parent_id)  selected  @endif>{{$item->name}}</option>
                                    ...
                                    <div class="input-group-text">
                                        <div class="n-chk align-self-end">
                                            <label class="new-control new-radio radio-info" style="height: 21px; margin-bottom: 0; margin-right: 0">
                                                <input type="radio" value="1" checked name="type" class="new-control-input" name="custom-radio-1" >
                            ...
                            <div class="input-group mb-4">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        <div class="n-chk align-self-end">
                                            <label class="new-control new-radio radio-info" style="height: 21px; margin-bottom: 0; margin-right: 0">
                                                <input type="radio" value="2" name="type"  class="new-control-input" id="show" name="custom-radio-1" >
                                                <span class="new-control-indicator"></span>
                                            </label>
                                        </div>
                                    </div>
