   ...
   <script src="{{asset('asset/admin/plugins/blockui/jquery.blockUI.min.js')}}"></script>
   <!-- <script src="plugins/tagInput/tags-input.js"></script> -->
   <script src="{{asset('asset/admin/assets/js/users/account-settings.js')}}"></script>
   <script src="{{asset('asset/admin/plugins/table/datatable/datatables.js')}}"></script>
   <script src="{{asset('asset/admin/plugins/table/datatable/custom_miscellaneous.js')}}"></script>
   <script src="{{asset('asset/admin/plugins/file-upload/file-upload-with-preview.min.js')}}"></script>
