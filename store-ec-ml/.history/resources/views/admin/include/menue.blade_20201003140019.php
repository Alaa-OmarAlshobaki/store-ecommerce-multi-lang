        ...
        <ul class="list-unstyled menu-categories" id="topAccordion">
            ...
            <li class="menu single-menu">
                ...
                <ul class="collapse submenu list-unstyled" id="tables"  data-parent="#topAccordion">
                    ...
                    <a href="#datatable" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> {{__('admin/setting.Shipping_Method')}}{{getIcon}}</a>
                    ...
                    <li class="sub-sub-submenu-list">
                        <a href="#datatable" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Shipping Method {{getIcon()}} </a>
                        <ul class="collapse list-unstyled sub-submenu" id="datatable" data-parent="#datatable">
                            <li>
            ...
            <li class="menu single-menu">
                ...
                <ul class="collapse submenu list-unstyled" id="page"  data-parent="#topAccordion">
                    ...
                    <li class="sub-sub-submenu-list">
                        <a href="#pages-error" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Error {{getIcon()}} </a>
                    ...
                    <li class="sub-sub-submenu-list">
                        <a href="#user-login" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Login {{getIcon()}} </a>
                    ...
                    <li class="sub-sub-submenu-list">
                        <a href="#user-register" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Register {{getIcon()}} </a>
                    ...
                    <li class="sub-sub-submenu-list">
                        <a href="#user-passRecovery" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Password Recovery {{getIcon()}} </a>
                    ...
                    <li class="sub-sub-submenu-list">
                        <a href="#user-lockscreen" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Lockscreen {{getIcon()}} </a>
            ...
            <li class="menu single-menu">
                ...
                <ul class="collapse submenu list-unstyled" id="more" data-parent="#topAccordion">
                    ...
                    <li class="sub-sub-submenu-list">
                    <a href="#starter-kit" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Starter Kit {{getIcon()}}</a>
