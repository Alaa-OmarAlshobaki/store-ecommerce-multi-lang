...
<head>
    ...
    <!--  BEGIN CUSTOM STYLE FILE  -->D:\my project\store-ecommerce-multi-lang\store-ec-ml\public\asset\admin\plugins\dropify\dropify.min.css
    <link rel="stylesheet" type="text/css" href="{{asset('asset/admin/assets/plugins/dropify/dropify.min.css')}}">
