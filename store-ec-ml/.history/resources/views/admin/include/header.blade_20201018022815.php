...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('asset/admin/plugins/table/datatable/custom_dt_miscellaneous.css')}}">
    ...
    <link href="{{asset('asset/admin/assets/css/elements/avatar.css')}}" rel="stylesheet" type="text/css" />
