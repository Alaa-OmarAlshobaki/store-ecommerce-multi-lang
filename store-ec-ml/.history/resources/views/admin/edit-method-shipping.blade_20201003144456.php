...
<div class="statbox widget box box-shadow mt-5 ">
    ...
    <div class="row mb-4 mt-3">
        <div class="col-sm-3 col-12">
            ...
            <a class="nav-link mb-2" id="v-pills-messages-tab" data-toggle="pill" href="#shipping-method" role="tab" aria-controls="v-pills-messages" aria-selected="false">{{__('admin\setting.')}}</a>
