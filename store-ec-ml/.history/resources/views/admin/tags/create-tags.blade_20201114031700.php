     ...
     <div class="row">
        <div id="custom_styles" class="col-lg-12 layout-spacing col-md-12">
            <div class="statbox widget box box-shadow">
                ...
                <form class="needs-validation" novalidate action="{{route('store.brands')}}" method="post" enctype="multipart/form-data">
                    @csrf
                        <div class="form-row">
                            ...
                            <input type="text" class="form-control" id="validationCustom01" placeholder="" value="{{old('slug')}}" name="name" required>
                                @error('slug')
                                <p class="text-danger"> {{$message}}</p>
