                 ...
                 <div class="login-wrap">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="phone" type="text" class="form-control @error('mobile') is-invalid @enderror" name="mobile" value="{{ old('mobile') }}" required >
                        ...
                        Already have and account ! <a href="{{ route('login') }}"><strong>Login now</strong></a>
                    </form>
                 </div>
             </div>
        </div>              
