                ...
                <form class="needs-validation" novalidate action="{{ route('store-control-user') }}" method="post">
                    @csrf
                        ...
                        <div class="form-row">
                            ...
                            <input type="password" class="form-control" id="validationCustom01" placeholder="" value="{{ $admin->password }}" name="password_confirmation" required>
                        ...
                        <div class="form-row">
                            <div class="col-md-5 mb-6">
                                ...
                                <select class="form-control tagging" name="role_id"
                                    ...
                                    <option value="{{ $item->id }}" @if($item->id == $admin->role_id) selected  @endif>{{ $item->name }}</option>
                                    @endforeach
                                    @endisset
