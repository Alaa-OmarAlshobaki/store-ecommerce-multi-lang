        ...
        <div class="header-mid">                       
                   ...
                   <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    @isset($category -> SubCate)
                                    @foreach ($category -> SubCate as $items)
                                    <li><a href="{{ route('cat-slug',$items->slug) }}"> {{ $items->name }}</a></li>
                                    @endforeach
                                    @endisset
                                </ul>
                            </li> 
            ...
            <div class="header-mid-right"> 
                <div class="header-cart style2">
                    <a href="{{ route('view.wishlist') }}" class="crt-btn pe-7s-like"></a> 
                </div>
                <!--header mini cart-->
                ...
                {{-- <div class="header-cart style2">
                    ...
                    <div class="cart-count">
                        ...
                        <strong>${{ $basket->subTotalQuan() }}</strong>
                    </div>
                 
                    <div class="widget widget_shopping_cart ">
                        <h5 class="title">Your cart have (<span>{{ $basket->itemCount() }}</span> Items)</h5>
                        <ul class="neo-mini-cart">
                            @isset($basket)
                            @foreach($basket->all() as $item)
                            <li class="item">
                                <figure class="product-thumb">
                                   <a href="#"><img src="{{ $item->image[0]->photo }}" alt=""></a>
                                </figure>
                                <!--product thumb-->

                                <div class="item-disc">
                                    <h6 class="pri-font">{{ $item->name }}</h6>
                                    <span class="qty">{{ $item->quantity }}</span> X <span class="item-price">{{$item->price   }}</span>
                                </div>
